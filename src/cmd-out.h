...
/* std fns */
#define cmd_out_screen_append(M, Items, Nitems)    str_append(cmd_out_screen(M), Items, Nitems)
...
#define cmd_out_screen_append_str(M,S)     str_append_str(cmd_out_screen(M), S)
#define cmd_out_screen_append_str_ln(M, S) str_append_str_ln(cmd_out_screen(M), S)
